...
public class PersMenu
{
	...
	{
		return new Option("Editer "+inscriptions.getPrenom(),"6",getActionModifPersonne(inscriptions));
	}
		...
		return new Action ()
		{
			...
			public void optionSelectionnee()
			{
				String nouveauNom = commandLine.util.InOut.getString("Nom: "),
						nouveauPrenom = commandLine.util.InOut.getString("Prénom: "),
						nouveauMail = commandLine.util.InOut.getString("Mail : ");
