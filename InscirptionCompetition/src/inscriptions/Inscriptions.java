...
public class Inscriptions implements Serializable
{
	...
	{
	//EQUIPE PERSONNE ET COMPETITION
		Inscriptions.db = db;
		if (db) {
			Persistance.Requete.chargeEquipes(this);
			Persistance.Requete.chargePersonnes(this);
			Persistance.Requete.chargeCompet(this);
		}
	}
	...
	{
		if (db){
			Persistance.Requete.affichEquipe();
			Persistance.Requete.affichePersonne(inscriptions);
	}
